...
local wrap_group = vim.api.nvim_create_augroup("maxxkph-filetype-wrap", { clear = true })
...
-- Filetypes whose treesitter indent is worse than the built-in. Add entries as
-- `["<filetype>"] = true`; upstream had ocaml here, which no longer applies.
local treesitter_indent_disabled_filetypes = {}

local treesitter_group = vim.api.nvim_create_augroup("maxxkph-treesitter-main", { clear = true })
